 ...
 *
 * Gives admin UIs a first-class grouping key to `GROUP BY` when rendering large
 * permission catalogues. The column is nullable so existing rows are unaffected
 * and categorisation is opt-in.
 *
