...
/**
 * `PolicyResolver` decorator that routes `policiesFor()` through
 * the resolution cache.
 *
 * Wraps any existing resolver — the default, a tenant-scoped
 * variant, or a consumer-supplied implementation — and consults
 * the cache before delegating to the inner resolver. The inner
 * resolver stays responsible for gathering strategy; this
