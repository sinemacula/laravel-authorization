...
/**
 * Thrown when a system-flagged policy would be deleted or renamed
 * without the explicit `forceSystem()` escape hatch.
 *
 * Protects platform-shipped policies (e.g. `break-glass`,
 * `system-audit`) from accidental removal by a caller with raw
 * Eloquent access. The exception carries the policy's current
 ...
 */
class SystemPolicyProtectedException extends \RuntimeException
{
    /**
