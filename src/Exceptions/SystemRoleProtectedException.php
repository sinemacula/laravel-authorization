...
/**
 * Thrown when a system-flagged role would be deleted or renamed without the
 * explicit `forceSystem()` escape hatch.
 *
 * Protects platform-shipped roles (`super-admin`, `auditor`, `owner`) from
 * accidental removal by a caller with raw Eloquent access. The exception
 * carries the role's current name so audit and error reporting can identify the
 * offending target.
 *
 * @author      Ben Carey <bdmc@sinemacula.co.uk>
 * @copyright   2026 Sine Macula Limited
 */
final class SystemRoleProtectedException extends \RuntimeException
{
    /**
