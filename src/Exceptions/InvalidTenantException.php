 ...
 *
 *   - `Illuminate\Database\Eloquent\Model` — reads `getMorphClass()` and
 *     `getKey()`.
 *   - `SineMacula\Laravel\Authorization\Contracts\AuthorizableTenant` — reads
 *     `getMorphClass()` and `getKey()` via the contract.
 *
