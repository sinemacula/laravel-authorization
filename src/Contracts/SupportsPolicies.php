 ...
 *
 * Split from the composite `AuthorizableIdentity` so a consumer who only needs
 * policy attachment — no direct RBAC grants — can typehint on the minimum
 * surface they actually implement. The parameters widen to `Policy|Model` to
 * match the shipped trait, letting consumers pass their own policy subclass or
 * a duck-typed model.
 *
