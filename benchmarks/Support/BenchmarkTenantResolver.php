 ...
 *
 * Returns a stable `BenchmarkTenant` every call so the memoised resolver result
 * is identity-stable across the request and the warm / cold benches measure
 * only the scope apply path.
 *
