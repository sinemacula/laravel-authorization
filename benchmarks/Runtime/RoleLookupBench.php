 ...
 * guard-specific row (`guard_name = 'web'`) and a guard-agnostic row
 * (`guard_name = null`). Together they cover the disjunction the hot path has
 * to evaluate on every RBAC check.
 *
