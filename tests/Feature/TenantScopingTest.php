...
class TenantScopingTest extends TestCase
{
    ...
    public function testNullResolverShowsAllRoles(): void
    {
        ...
        Role::create(['name' => 'global-role', 'guard' => 'web']);
        Role::create([
            'name'        => 'tenant-role',
            'guard'       => 'web',
    ...
    public function testNullResolverShowsAllPermissions(): void
    {
        ...
        Permission::create(['name' => 'global-perm', 'guard' => 'web']);
        Permission::create([
            'name'        => 'tenant-perm',
            'guard'       => 'web',
            'tenant_type' => $tenantA->getMorphClass(),
    ...
    public function testResolveByNameReturnsTenantScopedPermission(): void
    {
        ...
        Permission::create(['name' => 'posts:edit', 'guard' => null]);
        Permission::create([
            'name'        => 'posts:edit',
            'guard'       => 'web',
            'tenant_type' => $tenantA->getMorphClass(),
    ...
    {
        $role = Role::create(['name' => 'global', 'guard' => 'web']);
    ...
    {
        $permission = Permission::create(['name' => 'global-perm', 'guard' => 'web']);
    ...
    public function testScopeForTenantFiltersRolesByTenant(): void
    {
        ...
        Role::create(['name' => 'global', 'guard' => 'web']);
        Role::create([
            'name'        => 'role-a',
            'guard'       => 'web',
            'tenant_type' => $tenantA->getMorphClass(),
