...
/**
 * Sync fixture carrying an explicit empty `guards: []` attribute —
 * exercises the walker's `InvalidPermissionAttributeException` path
 * from the sync command integration surface.
 *
